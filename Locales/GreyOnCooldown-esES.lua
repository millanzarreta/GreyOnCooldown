...
L['GREYONCOOLDOWN_HELP_LINE3'] = '/GreyOnCooldown: Muestra el panel de configuración de GreyOnCooldown.'
L['GREYONCOOLDOWN_HELP_LINE4'] = '/GreyOnCooldown <enable|disable> o /GreyOnCooldown <on|off>: Activa o desactiva GreyOnCooldown.'
L['GREYONCOOLDOWN_HELP_LINE5'] = '/GreyOnCooldown minduration <value|default>: Establece el valor de la opción minDuration.'
L['GREYONCOOLDOWN_HELP_LINE6'] = '/GreyOnCooldown profiles: Muestra el panel de configuración de perfiles de GreyOnCooldown.'
