...
L['GREYONCOOLDOWN_HELP_LINE8'] = '/GreyOnCooldown minduration <value|default>: Set the minDuration option value.'
L['GREYONCOOLDOWN_HELP_LINE9'] = '/GreyOnCooldown profiles: Shows the profiles GreyOnCooldown config panel.'
